...
const skills = [
  ...
  { name: "Mysql", icon: <SiMysql size={40} className="text-[#00758F]" /> },
  {
    name: "Vscode",
  ...
  {
    name: "eclipse",
    icon: <DiEclipse size={40} className="text-[#1100cc]" />,
  },
];
...
export default function Skills() {
  return (
    <section
      id="skills"
      className="py-16 px-4 bg-gradient-to-br from[#0f0f0f] via-[#1c1c1e] to-[#2c2c2e] text-white"
    >
      <div className="max-w-6xl max-auto text-center">
        <h2 className="text-4xl font-bold mb-10 text-orange-500">Skills</h2>
